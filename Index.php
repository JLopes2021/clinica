        ...
        <div id="content">
            <div class="row">
                <div class="col mt-2">
                    ...
                    <div class="footer" style="text-align: center; background-color: #dbfbff; padding: 10px;">
                        <p style="color: #333; font-size: 14px; font-family: Arial, sans-serif;">Clínica Estética Esteticistas LTDA</p>
                    </div>
                </div>
            </div>
        </div>
